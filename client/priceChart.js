...
var color = d3.scale.ordinal().range(["#1f78b4", "#33a02c", "#e31a1c","#ff7f00", "#6a3d9a","#b15928"])
...
d3.tsv("data2.tsv", function(error, data) {
  ...
  var categories = color.domain().map(function(name) { // Nest the data into an array of objects with new keys
    ...
    return {
      ...
      visible: (name === "All_India" ? true : false) // "visible": all false except for All_India which is true.
    };
  });
 ...
 var brush = d3.svg.brush()//for slider bar at the bottom
  ...
  svg.append("g")
    ...
    .append("text")
      ...
      .text("Retail Price of  Milk (Rs/l)");
  ...
  issue.append("rect")
      ...
      .on("click", function(d){ // On click make d.visible
        ...
        yScale.domain([minY-10,maxY+10]); // Redefine yAxis domain based on highest y value of categories data with "visible"; true
        svg.select(".y.axis")
          .transition()
          .call(yAxis);
